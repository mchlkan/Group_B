"""Project Okavango — Data Explorer page.

This module contains the interactive dashboard for environmental data
analysis, previously the main application.  It uses the ``OwidData``
class from ``app.data`` to populate maps, charts, KPIs, and detail
panels.
"""
